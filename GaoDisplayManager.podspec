#
#  Be sure to run `pod spec lint GaoDisplayManager.podspec' to ensure this is a
...
spec.license      = { :type => "MIT", :file => "LICENSE-MIT" }
  ...
  # spec.social_media_url   = "http://www.tinywind.top"
  ...
  spec.source       = { :git => "https://github.com/GikkiAres/GaoDisplayManagerDemo.git", :tag => "#{spec.version}" }
